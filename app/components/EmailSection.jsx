    ...
    <section className="grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative">
      ...
      <div className="z-10">
        ...
        <div className="socials flex flex-row gap-2">
          <Link target="_blank" href="https://github.com/Abhishek65a">
            <Image src={GithubIcon} alt="Github Icon" />
          </Link>
          <Link target="_blank" href="https://www.linkedin.com/in/abhishek-tupsundar-7aab9b220/">
      ...
      <div>
        <form className="flex flex-col" onSubmit={handleSubmit}>
          <div className="mb-6">
            <label className=" text-[#9CA2A9]">
              At current you can contact me through this email:
              abhishektupsundar1@gmail.com
            </label>
            <label
              htmlFor="email"
